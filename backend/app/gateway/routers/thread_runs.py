...
:class:`talonflow.agents.runs.RunManager` and
:class:`talonflow.agents.stream_bridge.StreamBridge`.
...
from talonflow.runtime import RunRecord, serialize_channel_values
...
class RunCreateRequest(BaseModel):
    ...
    context: dict[str, Any] | None = Field(default=None, description="TalonFlow context overrides (model_name, thinking_enabled, etc.)")

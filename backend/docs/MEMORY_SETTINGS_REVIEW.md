...
1. Start TalonFlow locally using any working development setup you already use.
   ...
   If you already have TalonFlow running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.talon-flow/memory.json`

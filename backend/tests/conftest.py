...
# Make 'app' and 'talonflow. importable from any working directory
sys.path.insert(0, str(Path(__file__).parent.parent))

# Break the circular import chain that exists in production code:
#   talonflow.subagents.__init__
#     -> .executor (SubagentExecutor, SubagentResult)
#       -> talonflow.agents.thread_state
#         -> talonflow.agents.__init__
#           -> lead_agent.agent
#             -> subagent_limit_middleware
#               -> talonflow.subagents.executor  <-- circular!
#
# By injecting a mock for talonflow.subagents.executor *before* any test module
...
sys.modules["talonflow.subagents.executor"] = _executor_mock

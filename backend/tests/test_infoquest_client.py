...
from talonflow.community.infoquest import tools
from talonflow.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("talonflow.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("talonflow.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("talonflow.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/talon-flowv2/talon-flow/backend/tests/test_infoquest_client.py

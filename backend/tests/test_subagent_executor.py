...
talonflow.subagents.executor. This test file uses delayed import via fixture to test
...
_MOCKED_MODULE_NAMES = [
    "talonflow.agents",
    "talonflow.agents.thread_state",
    "talonflow.agents.middlewares",
    "talonflow.agents.middlewares.thread_data_middleware",
    "talonflow.sandbox",
    "talonflow.sandbox.middleware",
    "talonflow.models",
]
...
def _setup_executor_classes():
    ...
    original_executor = sys.modules.get("talonflow.subagents.executor")

    # Remove mocked executor if exists (from conftest.py)
    if "talonflow.subagents.executor" in sys.modules:
        del sys.modules["talonflow.subagents.executor"]
    ...
    from talonflow.subagents.executor import (
        SubagentExecutor,
        SubagentResult,
        SubagentStatus,
    )
    ...
    if original_executor is not None:
        sys.modules["talonflow.subagents.executor"] = original_executor
    elif "talonflow.subagents.executor" in sys.modules:
        del sys.modules["talonflow.subagents.executor"]
...
class TestCleanupBackgroundTask:
    ...
    def executor_module(self, _setup_executor_classes):
        ...
        from talonflow.subagents import executor

...
task_tool_module = importlib.import_module("talonflow.tools.builtins.task_tool")
...
def test_task_tool_emits_running_and_completed_events(monkeypatch):
    ...
    # task_tool lazily imports from talonflow.tools at call time, so patch that module-level function.
    monkeypatch.setattr("talonflow.tools.get_available_tools", get_available_tools)
